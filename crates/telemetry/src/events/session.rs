...
mod tests {
    ...
    #[test]
    fn session_end_serializes() {
        let event = TelemetryEvent::session_end(
            "sess",
            10,
            None,
            SessionEndPayload {
    ...
    fn config_loaded_serializes() {
        ...
        assert_eq!(event.kind(), "config_loaded");
    }
    ...
    fn startup_timing_serializes() {
        ...
        assert_eq!(event.kind(), "startup_timing");
    }
    ...
    fn shutdown_signal_serializes() {
        ...
        assert_eq!(v["total_turns"], 10);
        assert_eq!(event.kind(), "shutdown_signal");
    }
}
