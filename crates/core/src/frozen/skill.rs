...
/// with no corresponding argument expands to an empty string, unlike an
/// *indexed* placeholder with no argument, which is left unchanged — that
