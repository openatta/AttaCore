...
- **activeForm** (optional): Present continuous form shown in the spinner when the task is in_progress (e.g., "Running tests"). If omitted, the spinner shows the subject instead.
